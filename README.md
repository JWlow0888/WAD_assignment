	1. Import the database: Open phpMyAdmin (localhost/phpmyadmin), create/select the gamegear_exchange database, and import gamegear_exchange.sql from the project root.
