...
$available_products = [
    101 => ["title" => "PlayStation 4 Pro (1TB)", "condition" => "Used - Good", "price" => 1200],
    102 => ["title" => "MSI GTX 1660 Super", "condition" => "Refurbished", "price" => 850],
    103 => ["title" => "Zelda: Breath of the Wild (Switch)", "condition" => "Like New", "price" => 150],
    104 => ["title" => "Xbox Series S 512GB", "condition" => "Open Box", "price" => 1800],
    105 => ["title" => "Keychron Q1 Mechanical Keyboard", "condition" => "Open Box", "price" => 409],
    106 => ["title" => "Asus Tuf RTX 3070 8GB OC", "condition" => "Used - Pristine (Non-Mining)", "price" => 1199],
    107 => ["title" => "PlayStation 6 (Digital Edition)", "condition" => "Refurbished", "price" => 1499],
    107 => ["title" => "AMD Custom Gaming PC (ROG)", "condition" => "Slightly used", "price" => 9900],
];
                ...
                <div style="overflow-x: auto;">
                    <table class="purchase-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" name="products[]" value="<?php echo $id; ?>" 
                                    <?php echo (isset($_POST['products']) && in_array($id, $_POST['products'])) ? 'checked' : ''; ?>
